...
class CoupleTest < ActiveSupport::TestCase
  ...
  test 'Couple.couple returns nil when couple does not exist' do
  ...
  test 'ransackable_attributes returns correct attributes' do
    ...
    expected_attrs = %w[id created_at local marriage separation updated_at deleted_at
                        couple_person1_name_or_couple_person2_name]
  ...
  test 'mates omits a soft-deleted spouse so the show page can not deref nil' do
