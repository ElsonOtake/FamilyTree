...
class FavoritePolicyTest < ActiveSupport::TestCase
  ...
  test 'destroy? denies third party from destroying any favorite' do
    ...
    Favorite.create!(user: @third_user, person: Person.create!(name: 'Third Person', birth_year: 1995))
  ...
  test 'only overrides index?, create? and destroy? methods' do
    ...
    expected_overrides = %i[index? create? destroy?]
    ...
    not_overridden = %i[show? new? update? edit?]
