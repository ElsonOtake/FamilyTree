...
class PagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'statistics handles people with birth years correctly' do
    ...
    Person.create!(name: 'Person 1980', birth_year: 1980)
    Person.create!(name: 'Person 1985', birth_year: 1985)
    Person.create!(name: 'Person 1990', birth_year: 1990)
    Person.create!(name: 'Person 1995', birth_year: 1995)
