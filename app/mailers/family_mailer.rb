class FamilyMailer < ApplicationMailer
  ...
  def person_created
    ...
    mail to: "eaorigami@gmail.com", subject: "Person created: #{@person.name} (#{@person.id}) by #{@user.name}"
  end
  ...
  def person_updated
    ...
    mail to: "eaorigami@gmail.com", subject: "Person updated: #{@person.name} (#{@person.id}) by #{@user.name}"
  end
  ...
  def couple_created
    ...
    mail to: "eaorigami@gmail.com", subject: "Couple created: #{@person_1_name} & #{@person_2_name} (#{@couple.id}) by #{@user.name}"
  end
  ...
  def couple_updated
    ...
    mail to: "eaorigami@gmail.com", subject: "Couple updated: #{@person_1_name} & #{@person_2_name} (#{@couple.id}) by #{@user.name}"
  end
  ...
  def couple_deleted
    ...
    mail to: "eaorigami@gmail.com", subject: "Couple deleted: #{@person_1_name} & #{@person_2_name} (#{@id}) by #{@user.name}"
  end
